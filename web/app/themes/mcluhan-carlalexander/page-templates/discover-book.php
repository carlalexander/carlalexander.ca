...
<head>
    ...
    <link href="<?= get_stylesheet_directory_uri(); ?>/assets/css/material-kit.min.css" rel="stylesheet" />
...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/assets/images/discover-top-desk.jpg');">
    <div class="container">
        <div class="row">
...
<div class="main main-raised">
    ...
    <div>
        <div class="subscribe-line subscribe-line-image" style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/assets/images/escheresque_ste.png');">
            <div class="container">
        ...
        <div class="container text-center">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card-header card-header-image">
                                    <img class="img" src="<?= get_stylesheet_directory_uri(); ?>/assets/images/rachel-cherry.jpg">
                                    <div class="colored-shadow" style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/assets/images/rachel-cherry.jpg'); opacity: 1;"></div></div>
                            </div>
                            <div class="col-md-9">
                                <div class="card-body">
                                    <p>
                ...
                <div class="col-md-7 ml-auto mr-auto">
                    <div class="card card-profile card-plain card-testimonial">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card-header card-header-image">
                                    <img class="img" src="<?= get_stylesheet_directory_uri(); ?>/assets/images/tessa-kriesel.jpg">
                                    <div class="colored-shadow" style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/assets/images/tessa-kriesel.jpg'); opacity: 1;"></div></div>
                            </div>
                            <div class="col-md-9">
                                <div class="card-body">
                                    <p>
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center d-flex">
                    <a href="https://gum.co/wordpress-oop-team" class="btn btn-primary btn-round align-self-center mx-auto" data-gumroad-single-product="true">Buy for your team</a>
                </div>
            </div>
        </div>
    </div>
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-7 ml-auto mr-auto">
                    <div class="text-center">
                        <img src="<?= get_stylesheet_directory_uri(); ?>/assets/images/carl-alexander.jpg" width="150" height="150" alt="Carl Alexander" class="img-raised rounded-circle img-fluid">
