	...
	<div class="comments-wrap">
		...
		<div id="comments">
			...
			<?php if ( have_comments() ) : ?>
				...
				<h3 id="comments-number" class="comments-header block-title"><span><?php comments_number( __( 'No Responses', hybrid_get_parent_textdomain() ), __( 'One Response', hybrid_get_parent_textdomain() ), __( '% Responses', hybrid_get_parent_textdomain() ) ); ?></span></h3>
